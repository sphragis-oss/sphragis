...
// euDetectors is the opt-in EU pack, prepended so VAT wins over the IBAN matcher.
...
// amkaValid checks a Greek AMKA: 11 digits, plausible date prefix, Luhn.
...
// afmValid checks a Greek AFM (tax id) via the modulo-11 check digit.
